            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-info">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti, neque ipsam repudiandae nam
                ...
                <div class="col-md-6">
                    <div class="product-single row">
                        ...
                        <div class="product-cont col-lg-6">
                            ...
                            <a href><i class="icon-shopping-cart2"></i>Add to card</a>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                    <div class="section-heading text-center">
                        ...
                        <p class="text-white">Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit
